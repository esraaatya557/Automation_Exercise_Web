...
public class InvoiceTest extends BaseTest {
    ...
    @Test(dependsOnMethods = {"paymentTest", "checkout", "addProductToCart", "registerNewAccount"})
    ...
    @Test(dependsOnMethods = {"downloadInvoice", "paymentTest", "checkout", "registerNewAccount"})
