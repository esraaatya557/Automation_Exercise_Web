...
public class SignupPage {
    ...
    @Step("Fill Registration Form With Minimal Data")
    public SignupPage fillRegisterationFormWithMinimalData(String passwordText, String firstNameText, String lastNameText) {
        chooseTitle("Mrs");
        driver.element().type(password, passwordText);
        driver.element().selectFromDropdown(day, "16");
        driver.element().selectFromDropdown(month, "June");
        driver.element().selectFromDropdown(year, "2001");
        driver.element().click(newsletter);
        driver.element().click(specialOffers);
        driver.element().type(firstName, firstNameText);
        driver.element().type(lastName, lastNameText);
        ...
        driver.element().type(address1, "address1Text");
        driver.element().type(address2, "address2Text");
        driver.element().selectFromDropdown(country, "India");
        driver.element().type(state, "stateText");
        driver.element().type(city, "cityText");
        driver.element().type(zipcode, "12345");
        driver.element().type(mobileNumber, "1233455988");
        return this;
    }
